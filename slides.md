...
fonts:
  ...
  serif: Noto Serif JP
download: true
title: 想像の多世界説――準観察テーゼを反駁し直す
---

# 想像の多世界説<br />――準観察テーゼを反駁し直す――
...
多世界説の観点からの準観察テーゼ論駁を通じて、多世界説の威力を実践的に掴んでもらう
...
- 直観の水準だけでなく判断の水準においても、固定的な身体位置と可変的な視点位置の区別がパラレルに存在する
...
- 直観と判断の差異については以下を参照
	- > 例えば実験のために自ら進んで幻覚剤を注射してもらったサルトルのように、幻覚だと知られている幻覚というものがありうる。白昼にエビやカニが壁に這っている訳がなく、またこの視覚を生み出しているのは以前のメスカリン注射のせいだと知っているので、カニは判断上は非現実的なものとして〔…〕定立される。しかしどんなに知として知っていようともカニは実際に現にそこに見えてしまうので、その現前性の意味での現実性を判断によって否定することはどうしてもできない。〔…〕「現実性」は、判断においては定立された信念妥当性を意味し、直観においては現にそこに現出しているという意味での現前的現実性を意味するのである。（本論文6-1）

---

# 準観察から中立性変様へ——想像と虚構（つづき）

- 直観的な意味での非現実性とは**想像**（準現在化）であるが、判断的な意味での非現実性とは**虚構**である
	- 虚構性とは、例えば新聞と小説を区別するときに用いられている差異。「フィクション」もその一種
- この虚構についても、想像においてと同様、サルトルの準観察テーゼと同型の立場が存在する
	- →フィクション論におけるケンダル・ウォルトンのごっこ遊び make-blieve 説
	- これを同じく弁証法的に論駁することで、多世界説の判断論バージョンを展開するとともに、それをフッサールの「中立性変様」概念に接続する
- 直観の水準と判断の水準の絡み合いが我々の知覚経験や想像経験をどうやって差異化しているのか記述する
  - 判断という観点のみから見たとき、夢と想像とフィクションは区別ができない
    - いずれも判断上実在しないもの、判断上の世界2に属するものなので
  - 直観という観点のみから見たとき、目覚めた知覚と夢も、想起と空想も区別できない
  	- 判断上虚構であるような準現在化が空想、判断上実在的であるような準現在化が想起
- 像への「観入」と虚構への「没入」の間の混同されやすい区別を施す
- 現象学的還元が直観的、判断的いずれの水準で生じる事柄なのかも考える
