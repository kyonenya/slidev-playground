...
- 直観的な意味での非現実性とは**想像**（準現在化）であるが、判断的な意味での非現実性とは**虚構**である
	...
	- 準現在化の中でも虚構であるものとそうでないものがある。判断上虚構であるような準現在化が空想であり、判断上虚構ではなく実在的であるような準現在化が想起である
- この虚構においても、想像においてと同様、サルトルの準観察テーゼと同型の立場が存在する（→ケンダル・ウォルトンのごっこ遊び make-blieve 説）
	- これを同じく弁証法的に論駁することで、多世界説の判断論バージョンを展開するとともに、それをフッサールの「中立性変様」概念に接続する
- 像への「観入」と虚構への「没入」の間の混同されやすい区別を施す
	- 現象学的還元が直観的、判断的いずれの水準で生じる事柄なのか
